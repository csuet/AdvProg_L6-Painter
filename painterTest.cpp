...
bool verifySetColor(SDL_Color color) {
	...
	@@ -31,8 +32,6 @@ bool verifySetColor(SDL_Color color) {
    }
    return true;
}
bool verifyJumpForward(int numPixel, double angle, int curX, int curY, int diffX, int diffY) {
    SDL_Window *window;
    SDL_Renderer *renderer;
	@@ -50,8 +49,6 @@ bool verifyJumpForward(int numPixel, double angle, int curX, int curY, int diffX
      return false;
    }
}
bool verifyJumpBackward(int numPixel, double angle, int curX, int curY, int diffX, int diffY) {
    SDL_Window *window;
    SDL_Renderer *renderer;
	@@ -69,9 +66,7 @@ bool verifyJumpBackward(int numPixel, double angle, int curX, int curY, int diff
      return false;
    }
}
bool verifyTurnLeft(double degree, double curAngle, double expectedAngle) {
	...
	@@ -85,9 +80,7 @@ bool verifyTurnLeft(double degree, double curAngle, double expectedAngle) {
        return false;
    }
}
bool verifyTurnRight(double degree, double curAngle, double expectedAngle) {
    ...
    SDL_Renderer *renderer;
    initSDL(&window, &renderer);
	@@ -101,23 +94,20 @@ bool verifyTurnRight(double degree, double curAngle, double expectedAngle) {
        return false;
    }
}
...
void runTestLoop(TestStruct testCases[], int testSize) {
	...
	@@ -134,7 +124,6 @@ void runTestLoop(TestStruct testCases[], int testSize) {
        }
    }
}
class Test: public CPPUNIT_NS::TestCase {
  ...
  CPPUNIT_TEST(testMyPainterSetColor);
	@@ -144,217 +133,196 @@ class Test: public CPPUNIT_NS::TestCase {
